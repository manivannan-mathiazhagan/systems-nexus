...
data final;
	...
	space = '';
  	...
  	if aebodsys ^= ' ' and aedecod ^= ' ' and aetoxgrn ^= . and aetoxgrn ne 6 
	then formal = '    Grade ' || compress(put(aetoxgrn,best.));  
	if aebodsys ^= ' ' and aedecod ^= ' ' and aetoxgrn ^= . and aetoxgrn eq 6 
	then formal = '    Missing ';  
   	stat = 'n (%)'; 
