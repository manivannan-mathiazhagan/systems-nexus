...
************************************************************************************;
* PROGRAM:    P:\Projects\Cook MyoSite\DIFI - 22-01\Biostats\DSMB\_Restricted\Figures\f-14-3-2-vs.sas  
* DATE:       31Jul2025
...
*===============================================================================;
proc sort data=ads.advs out=advs;
  by trta paramn param paramcd avisitn avisit vstptnum vstpt;
  where saffl='Y' and paramcd ne "HGT" and trta ne "" ;
run;
...
data advs_mean;
	...
	if newvisn ne . then do; put "WAR" "NING: Need to review Code for Visit: " avisit; end;
...
footnote1 j=l "Abbreviations: SCR = Screening; BIOPSY PRE = pre-Biopsy, BIOPSY POST = post-Biopsy; INJ PRE = pre-Injection; INJ POST = post-Injection; WK1 = Week 1; MN6 = Month 6; MN12 = Month 12.";
footnote2 j=l "Source: Listing 16.2.7.2!n";
footnote3 j=l "&ft99";
