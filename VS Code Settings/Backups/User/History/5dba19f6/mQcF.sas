...
libname stdDAT  "P:\Biostatistics\Standard Datasets";
...
*PROC SORT;
*	BY parcat1 LABNUM LBTESTCD;
*ODS excel file="P:\ASPA\Canavan\ASPA-CVN-102\Data Mgmnt\Labs\Local Labs\Cleaning\NON-CONVERTED_SI_&sysdate..xlsX" style=MonochromePrinter; ; 
*proc print DATA=LOCALSI LABEL;
*  where lborresn ne . and lbstresN=. and parcat1  in('HEMATOLOGY' 'CHEMISTRY' 'COAGULATION');;
* var parcat1 LABNUM lbtestcd lbtest lborresn PR UNITC_DEC usubjid lbdAtC visitid visit lbstresN lbstresu;
*RUN;
*ODS EXCEL CLOSE;
*QUIT;  
