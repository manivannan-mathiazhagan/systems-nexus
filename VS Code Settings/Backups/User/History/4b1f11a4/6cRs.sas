...
proc sort data=raw.dat_mc_meddra(encoding=any) out=meddra( drop= VISNAME  PAGENAME VISITID  VISITSEQ
...
*===============================================================================; 
data qc;
retain &keyvars trtp trtpn trta trtan aeseq aeterm trtemfl aebodsys aedecod  astdt astdy aestdtc 
				AEENRF aendt aendy aeendtc
