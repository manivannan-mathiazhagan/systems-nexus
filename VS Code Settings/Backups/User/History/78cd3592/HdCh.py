...
from PyQt5.QtWidgets import (
    ...
    QTableWidget, QTableWidgetItem, QGroupBox, QTextEdit, QMessageBox
)
...
class TableShellTool(QWidget):
    ...
    def setup_ui(self):
        ...
        self.dropdown_group = QGroupBox("Available Table IDs")
        self.dropdown_group.setLayout(self.dropdown_layout)
    ...
    def load_excel(self):
        ...
        # Clear old buttons from dropdown
