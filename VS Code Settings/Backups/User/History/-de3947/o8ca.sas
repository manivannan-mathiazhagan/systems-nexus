...
************************************************************************************;
* PROGRAM:     P:\Projects\Cook MyoSite\DIFI - 22-01\Biostats\DSMB\QC\Listings\ql-16-2-7-3-lb.sas
* DATE:        01/21/2024
* PROGRAMMER:  uks
* PURPOSE:     Clinical Laboratory Results - Hematology (Safety Set)
*
************************************************************************************;
* MODIFICATIONS:  
...
* 
*************************************************************************************;
%let pgm=ql-16-2-7-3-lb;
%let pgmnum=16.2.7.3; 
%let pgmqc=l_16_2_7_3_lb_hem;
...
set ads.adlb;
where saffl = 'Y' and parcat1 = 'HEMATOLOGY';
