...
%macro TLF_Packager(input_path=, delete_pdfs=Y);
    ...
    /* Fix: Extract the last folder name from input_path */
...
/* Example Call */
%TLF_Packager(input_path=P:\Projects\Fusion Pharmaceuticals Inc\FPI-2265-202 (Mono Therapy)\Biostats\CSR\Tables);
