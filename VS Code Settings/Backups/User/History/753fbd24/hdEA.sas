...
%macro TLF_Packager(input_path=, delete_pdfs=Y, wait_approval=Y);
    ...
    data _null_;
        file "&batfile.";
        put '@echo off';
        put '"' "&pyexe." '" "' "&scriptpath." '" "' "&input_path." '" "' "&output_pdf." '" "' "&delete_pdfs." '" "' "&wait_approval." '" > "' "&logfile." '" 2>&1';
    run;
...
%TLF_Packager(input_path=P:\Biostatistics\PDF Tool\Testing Veristat PDF\RRP-002\2. Listings);
