...
%macro yes_pt(yesdsn);
    ...
    %imp_gdocjson(sheet=&yesdsn, gdoc_key
        =1EAf_6-H0aNTMCktK5P6KHy1pX-kKbWbjz794FTNvNlI, outlib=sdtmspec, force=1,
        add_rownums=1) %sdtm_create(speclib=sdtmspec, specds=&yesdsn, outlib
        =SDTM, pgmpath=&proot\Sdtm, source_id_vars=usubjid,studyid=);
%mend;
